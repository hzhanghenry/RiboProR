...
#*		Return:
#*
#*			List of integers for sizes of cds, 5-UTR, and 3-UTR.
#*
#*
...
#*		Return:
#*
#*			List of sizes for cds, 5-UTR, and 3-UTR of a transcript
#*
#*
...
#*
#*		Return: 
#*		Data frame with rows for transcript names and columns for size of
#*		transcript, cds, 5-UTR, and 3-UTR.
#*
#*
