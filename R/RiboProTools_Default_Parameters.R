...
getZeroInset <- function() {
    return (list(utr5Inset3=0, cdsInset5=0, cdsInset3=0, utr3Inset5=0));
}
	
getDefaultRiboSeqAsites <- function(){
    return (data.frame(asite=c(14,14,14,14,15,15), row.names=seq(26,31)));
}

getDefaultRNASeqAsites <- function() {
    return (data.frame(asite=rep(15, 34), row.names=seq(18,51)));
}
