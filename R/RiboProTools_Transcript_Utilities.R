...
#*		Return: 
#*
#*			an IRanges object for start and end position of a CD.
#*
#*
...
#*
#*		Returned value: none, result is writen to file.
#*
#*
...
#*
#*		Argument:	bam.file: character vector, bam file name.
