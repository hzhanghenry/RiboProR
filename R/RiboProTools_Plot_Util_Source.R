...
#*		Return:
#*
#*		A matrix with normalized count data
#*
...
#*
#*		Return:
#*		Vector of R colors with length of num_colors.
#*
...
#*
#*		Return:
#*		Vector of R colors with length of 24.
#*		
...
#'		Return:
#'
#'		Integer vector, x axis label for metage frame plot.
#'
#'
		...
		to_position=50, codon="Start", x_interval=10)
{
	...
	meta_counts <- read.table(count_file, header=TRUE, sep="\t",
						quote="");
...
#*			to_position:		Integer, stop position of metagene to plot 
#*
#*		Return:		Data matrix with read counts along metagene position 
#*					from multiple samples. Columns in matrix is sorted by
