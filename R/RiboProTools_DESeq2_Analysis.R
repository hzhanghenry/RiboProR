...
#*
#*    Note: All results are save in file and returned object is for saving
...
#*
#*
#*    Note: All results are save in file and returned object is for
#*    saving and debugging purposes.
#*
#*/
...
quickDESeq2Test <- function(count_table, 
    ...
    count_matrix <- filterCountMatrix(count_matrix, 
        mRNA_col, ribo_col, mRNA_level, Ribo_level);
...
getUORFCountMatrixFromTwoFileSets <- function(file_directory, 
    ...
    cds_counts  <- getCountMatrixFromFiles(file_directory, 
        cds_file_pattern, count_column, rowname_column, has.header);
    ...
    if(length(is.na(cds_rows)) > 0)
        stop("Some uorf do not match any gene.")
...
#*
#*    Return:  A data frame with contents described above.
#*
#*
