...
#*		Return:
#*
#*			A data frame containing a-site for fragments with selected 
#*			length. 
#*
#*
	...
	validate.parameters=TRUE, save.file=TRUE)
{
	...
	asite_table <- getASiteTable(frame_table, at_start, at_end, 
					parameters);
	message("done.")
...
#*		Return:
#*
#*			A numeric matrix with all zeros.
#*
#*		Note: the total count column is not included and will
#*			  be added later.
#*
#*
...
#*		Argument:
#*		
#*			frameProfile:	A data frame with two columns for frames and 
#*							read_len
#*
#*		Return:
#*
#*			A data frame with 7 columns for read_len, fraction, frame0  
#*			counts, frame1 counts, frame2 counts and fraction of the 
#*			three frames
#*
#*
...
#* 
#*
getASiteTable <- function(frame_table, at_start, at_end, 
					parameters)
{
	...
	#*		----------------------------------------------
	start_peak <- startShift + getReadPeaks(at_start, 
						minStartRange, maxStartRange);
	end_peak <- endShift + getReadPeaks(at_end,
						minEndRange, maxEndRange);
	...
	a_site_table <- data.frame(Fract=frame_table[,1],
